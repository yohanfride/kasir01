        ...
        <div class="col-md-12 col-lg-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Form Edit Data Cashflow</h4>
                </div>
                <div class="card-body">
                    <form method="post" class="form-material" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-format" data-name="tanggal" name="tanggal" placeholder="Masukkan Tanggal" required="required" value="<?= date_format(date_create($data->tanggal), 'Y-m-d'); ?>">
                            </div> 
                            <div class="form-group">
                                <label for="faktur">Faktur Transkasi</label>
                                <input type="text" class="form-control" id="faktur" name="faktur" placeholder="Masukkan No. Faktur" value="<?= $data->faktur;?>">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <select class="form-control" id="akun" name="akun" required>
                                        ...
                                        <option value="<?= $d->akun ?>" <?= ($d->akun == $data->nama_akun)?'selected':''; ?>  ><?= $d->akun ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control uang" id="total" name="total" placeholder="Masukkan Total Cashflow" required="required" value="<?= ($data->jenis == 'PEMASUKAN')?$data->debit:$data->kredit; ?> ">
                            </div>
                            <div class="form-group">
                                <label for="catatan">Catatan</label>
                                <textarea class="form-control" rows="3" id="catatan" name="catatan" ><?= $data->catatan;?></textarea>
                            </div> 
                        </div>
