						...
						<div class="col-md-12 col-lg-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form - Edit Maintenance Data</div>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="pic" name="pic" placeholder="Enter PIC Name " required="required" value="<?= $data->pic; ?>">
											</div>
											<div class="form-group">
												<label for="body-machine">Maintenance Start Date </label>
												<input type="text" class="form-control datepicker"  data-name="date_start" name="date_start" placeholder="Enter Maintenance Start Date" required="required" value="<?= $data->date_start; ?>">
											</div>
											...
											>
												...
												<input type="text" class="form-control datepicker" id="finish_date" data-name="date_finish" name="date_finish" placeholder="Enter Maintenance Start Date" value="<?= $data->date_finish; ?>" >
											</div>
										</div>
										...
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												...
												<input type="number" class="form-control" id="cost" name="cost" placeholder="Enter Total Cost" required="required"  value="<?= $data->cost ?>">
											</div>
											<div class="form-group">
											...
											<div class="form-group" id="divNextDate" 
											<?php if($data->status ==  0){ ?>
												style="display: none"
											<?php }  ?>
											>
