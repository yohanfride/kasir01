										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td><?= date("Y-m-d H:i:s", strtotime($d->date_take_order)) ?></td>
													<td><?= date("Y-m-d H:i:s", strtotime($d->date_on_location)) ?></td>
													<td><?= date("Y-m-d H:i:s", strtotime($d->date_start_transaction)) ?></td>
													<td><?= date("Y-m-d H:i:s", strtotime($d->date_finish)) ?></td>
													<td><?=  strtotime($d->date_finish) - strtotime($d->date_add) ?></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
