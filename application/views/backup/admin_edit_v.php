											...
											<div class="form-group">
												<div class="row">
													<div class="col-lg-6 col-md-12">
														<label for="phone">Managerial Page Acces</label>
														<div>
															<input type="checkbox" <?= ($data->business_access)?'checked':''; ?> name="managerial" data-toggle="toggle" data-onstyle="primary" style="width: 200px;" onchange="changeToggle(this)" value="1">
														</div>	
													</div>
													<div class="col-lg-6 col-md-12">
