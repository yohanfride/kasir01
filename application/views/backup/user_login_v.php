...
<body class="login">
	<div class="wrapper wrapper-login wrapper-login-full p-0">
		<div class="login-aside w-50 d-flex flex-column align-items-center justify-content-center text-center bg-easy-gradient">
			<h1 class="title fw-bold text-white mb-3"><img src="<?= base_url()?>assets/img/logo-black.png"  class="img-responsive" style="max-width: 280px ;"></h1>
			<p class="subtitle text-black op-7"><b>Integrate Through Innovation </b></p>
		</div>
