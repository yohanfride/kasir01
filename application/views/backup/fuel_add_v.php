						...
						<div class="col-md-8 col-lg-6">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form - Add New Fuel Data</div>
								</div>
									...
									<div class="row">
										<div class="col-md-12 col-lg-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="fuel" name="fuel" placeholder="Enter Fuel" required="required">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<textarea class="form-control" id="information" name="information" rows="2"></textarea>
											</div>
										</div>
									</div>
								</div>
