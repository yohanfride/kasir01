						...
						<div class="col-md-12 col-lg-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form - Add New Log Filling Data</div>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												...
												<select class="form-control" id="car" name="car" required>
													...
													?>
													<option value="<?= $id ?>"><?= $d->car->vehicle_number ?></option>
													<?php } ?>
												</select>
											</div>
											<div class="form-group">
												<label for="driver">Driver</label>
												<input type="text" class="form-control" id="driver_value" name="driver_value"  required="required" readonly="">
												<input type="hidden" class="form-control" id="driver" name="driver"   required="required">
											</div>
											<div class="form-group">
										...
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												...
												<input type="number" class="form-control" id="total_fuel" name="total_fuel" placeholder="Enter Filling Amount" value="0" required="required">
											</div>
											<div class="form-group">
