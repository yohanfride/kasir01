						...
						<div class="col-md-12 col-lg-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form - Edit Schedule Data</div>
								</div>
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											<div class="form-group">
												...
												<select class="form-control" id="driverData" name="driver" required="">
													...
													?>
													<option value="<?= $id ?>" <?php if($data->driver_id ==  $id) echo "selected" ?> > [ <?= $d->driver_code ?> ] <?= $d->name ?></option>
													<?php } ?>
												</select>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<select class="form-control" id="sectorData" name="sector">
													...
													<option value="<?= $d->sector ?>" <?php if($data->sector ==  $d->sector) echo "selected" ?> ><?= $d->city ?> - <?= $d->sector ?></option>
													<?php } ?>
												</select>
											</div>
											<div class="form-group">
												...
												<select class="form-control" id="statusData" name="status">
													<option value="1" <?php if($data->status == 1 ) echo "selected" ?> > On Trip ( Active )</option>
													<option value="0" <?php if($data->status == 0 ) echo "selected" ?> > Finish Trip ( Not Active )</option>
												</select>
											</div>
										</div>
									</div>
