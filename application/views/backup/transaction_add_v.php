									...
									<div class="row">
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group">
												...
												<select class="form-control" id="fuel-type" name="fuel-type" required>
													...
													foreach ($fuel as $d) { 
														$prices[] = $d->price; ?>
													<option value="<?= $d->fuel ?>"><?= $d->fuel ?></option>
													<?php } ?>
												</select>
											</div>
											<div class="form-group">
												<label for="model">Fuel Price</label>
												<input type="text" class="form-control" id="price" name="price" placeholder="Enter Fuel Price" required="required" value="<?php if(!empty($prices)) echo number_format($prices[0],0,',','.'); ?>" readonly>
											</div>
											<div class="form-group">
											...
											<div class="form-group row">
												<div class="form-group col-6">
													...
													<input type="text" class="form-control" id="fuel-total" name="fuel-total" placeholder="Enter Total" required="required" >
												</div>
												<div class="form-group col-6">
													<label for="model">Pay</label>
													<input type="text" class="form-control" id="pay-label" name="pay-label" placeholder="0" required="required" readonly>
													<input type="hidden" class="form-control" id="pay" name="pay" placeholder="0" required="required">
												</div>
											</div>
											<div class="form-group">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group ">
												...
												<input type="text" class="form-control" id="driver-name" name="driver-name" placeholder="-" required="required" readonly>
											</div>
											<div class="form-group ">
												<label for="model">Car Vehicle Number</label>
												<input type="text" class="form-control" id="car-name" name="car-name" placeholder="-" required="required" readonly>
											</div>
										</div>
