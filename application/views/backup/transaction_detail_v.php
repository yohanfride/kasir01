								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-6">
											...
											<?php if(!empty($customercar)){ ?>
											<div class="form-group">
												<label for="phone">Customer Car</label>
												<input type="text" class="form-control" id="customer" name="customer" placeholder="Enter Fuel Price" required="required" value="<?= $customercar->vehicle_number; ?>" disable>
											</div>
											<?php } ?>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="price" name="price" placeholder="Enter Fuel Price" required="required" value="[<?= $data->driver->driver_code; ?>] <?= $data->driver->name; ?>" disable>
											</div>
											<div class="form-group">
												<label for="phone">Car/Truck Vehicle Number</label>
...
<script type="text/javascript">
	...
	function initMaps(center){
		...
		function connect() {
			<?php if( ($data->status == 2) || ($data->status == 3) || ($data->status == 4) ){ ?>
				var new_point = {
					latlng : center
				};
				pubnub.publish({
		...
		map = eon.map({
            ...
            mb_id: 'mapbox.satellite',//'ianjennings.l896mh2e',
