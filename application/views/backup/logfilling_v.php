							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Log Filling Data List</h4>
										<a href="<?= base_url()?>logfilling/add/" class="ml-auto"><button class="btn btn-primary btn-round ml-auto">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												<?php foreach ($data as $d) { $id=number_format($d->log_filling_id,0,'',''); ?>
												<tr>
													...
													<td><?= $d->fuel_type ?></td>
													<td><?= number_format($d->total_fuel,0,',','.'); ?></td>
													<td>
														<?php if($d->status == 0){ ?>
														<span class="text-warning pl-3">On Log Filling</span>
	                                                    <?php } else if($d->status == 1){ ?>
	                                                    <span class="text-success pl-3">Finish</span>
	                                                    <?php }  ?>
													</td>
													<td>
														<div class="form-button-action">
															<a href="<?= base_url();?>logfilling/edit/<?= $id; ?>">
															...
															<a href="<?= base_url();?>logfilling/delete/<?= $id; ?>"  class="btn-delete">
