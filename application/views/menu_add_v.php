                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control uang" id="price" name="price" placeholder="Masukkan Harga Menu" required="required" inputmode="numeric">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">Diskon (%)</label>
                                        <input type="text" class="form-control persen" id="diskon" name="diskon" placeholder="Masukkan Diskon Menu (%)" required="required" inputmode="numeric" value="0,00">
                                    </div>
                                    <div class="form-group">
