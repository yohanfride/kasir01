...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Ubah Stok Bahan</li>
        </ol>
    </div>
    <div>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Form Ubah Stok Bahan</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Stok Bahan" required="required" value="<?= $data->nama?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="nama">Stok Awal Bahan</label>
                                        <input type="number" class="form-control uang" id="stok_awal" name="stok_awal" placeholder="Masukkan Stok Bahan" required="required" value="<?= $data->jumlah_stok?>" <?= ($status)?'readonly="true"':'' ?> >
                                    </div>
                                    <div class="form-group">
                                        <label for="nama">Satuan Bahan</label>
                                        <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Masukkan Satuan Bahan" required="required" value="<?= $data->satuan?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="name">Keterangan Stok Bahan</label>
                                        <textarea class="form-control" rows="3" id="detail" name="detail" ><?= $data->keterangan_stok; ?></textarea>
                                    </div>
                                </div>
                            </div> 
                        </div>
